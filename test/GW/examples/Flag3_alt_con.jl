...
println(con)
#hDict1 = [GKMtest._h(Edge(1, 2), d, con, F3_alt_con.equivariantCohomology) for d in 1:20];
...
#hDict2 = [GKMtest._h(Edge(1, 2), d, con, F3_alt_con.equivariantCohomology) for d in 1:20];
